...
contract Groth16Verifier {
    ...
    uint256 constant DELTA_NEG_X_0 =
        19986528044735803950861281223434143969792710448017158006517056713680638499839;
    uint256 constant DELTA_NEG_X_1 =
        5503032922596398984748155587901931253829095014261937060186522372059672973280;
    uint256 constant DELTA_NEG_Y_0 =
        15790562079159861158870345587936741191412805158591047095732538795991258802838;
    uint256 constant DELTA_NEG_Y_1 =
        7787690812367629609904499626353159414432715731533121044791785971292289050347;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        12990008511131002765066595154752860376294984849959100990783439365910915088081;
    uint256 constant CONSTANT_Y =
        14631816551094416877030470462528659550721078245618158541046209687249658940685;
    uint256 constant PUB_0_X =
        13571647276437077402617259350871064766280958387990431567049439186487444092570;
    uint256 constant PUB_0_Y =
        9540071600818563926640887880146796436208088700443560060514889940257970172397;
    uint256 constant PUB_1_X =
        13797829615967105725809407740815422086491138284230314483331173430326227031722;
    uint256 constant PUB_1_Y =
        11206421341341381353680982788434893821172293888852506310677092154333366054766;
