...
contract PlonkVerifier {
    ...
    uint256 private constant VK_QL_COM_X =
        11017851650409075923140539321729176177394039531242446638978158052803116666923;
    uint256 private constant VK_QL_COM_Y =
        17599572659513441062343483603091057008298901565997361814931182409846119517842;
    uint256 private constant VK_QR_COM_X =
        19184294438010963841758370265181474813954496889168308398621646367880965280736;
    uint256 private constant VK_QR_COM_Y =
        3648685054809527621273234855241642094886058802093772665920137371011527404105;
    uint256 private constant VK_QM_COM_X =
        19180305657317934841166320450393060493225273508496856111087777478788264874341;
    uint256 private constant VK_QM_COM_Y =
        8593533875195948766224556684700356854734530549060819788903850283839969104084;
    uint256 private constant VK_QO_COM_X =
        8206196500493168723794527708373991530316514145859685008176531627355076954549;
    uint256 private constant VK_QO_COM_Y =
        2653545118637252306012696309710914312555859110487651275158294927563758958678;
    uint256 private constant VK_QK_COM_X =
        12139476673152480223340723926687641251196912701339573790668488372509592053758;
    uint256 private constant VK_QK_COM_Y =
        9504337933272279610351059518961118933857980639326694153005605847287403053119;

    uint256 private constant VK_S1_COM_X =
        7856270089217725735000900775564952260697211830425771321869898279025489599763;
    uint256 private constant VK_S1_COM_Y =
        21270139325483817037098164345345527411574419490143385028809513555871522331988;

    uint256 private constant VK_S2_COM_X =
        7782514203889883485725225807828955258677031397122977506276256108317286437671;
    uint256 private constant VK_S2_COM_Y =
        1302622129806868317856422102420237620663156414536487131880714528426831623232;

    uint256 private constant VK_S3_COM_X =
        1875576710293977398180800596449105678407286345411134110280037365818760065063;
    uint256 private constant VK_S3_COM_Y =
        20445045698832212697656944564266680632210623598362377185455901191866624778501;

    uint256 private constant VK_COSET_SHIFT = 5;

    uint256 private constant VK_QCP_0_X =
        16097678432155375692948223085473511901074613993051482374243502972035405342097;
    uint256 private constant VK_QCP_0_Y =
        14937270591262716590336092273288063568150486192796642688307592073974881316135;

    uint256 private constant VK_INDEX_COMMIT_API_0 = 7676117;
