...
contract PlonkVerifier {
    ...
    uint256 private constant VK_QL_COM_X =
        8021999071749632672700239128273551688596444782946860113899097757458033891405;
    uint256 private constant VK_QL_COM_Y =
        19924398262365613760900445418205130439564835013375002430181126462169796798050;
    uint256 private constant VK_QR_COM_X =
        2602865713941632846222067170225203125198650284688629806342659183528653688601;
    uint256 private constant VK_QR_COM_Y =
        8071562557172653977945818873712541481277419824265932051921643004625372104996;
    uint256 private constant VK_QM_COM_X =
        10308611236458804772431170415533754279065026550656844771121914904540496072992;
    uint256 private constant VK_QM_COM_Y =
        18306367155937699095401169653676482461769737278472391320689146028116761417205;
    uint256 private constant VK_QO_COM_X =
        8852247163402615439136152270098165443915336434130457719531863857419562914154;
    uint256 private constant VK_QO_COM_Y =
        5656762911803997123102222447678167456306888048427175534200196026358984984618;
    uint256 private constant VK_QK_COM_X =
        11303801215478747009968998960094177482917484615245926913508697584971841751299;
    uint256 private constant VK_QK_COM_Y =
        8982962933815562256166639876116457303164213689443897060038469430341805095359;

    uint256 private constant VK_S1_COM_X =
        11916699603700667710299271940576669137227434459148235180591193494513752524895;
    uint256 private constant VK_S1_COM_Y =
        20165678500237810063128163555784621301583789039627608539774154712426980332221;

    uint256 private constant VK_S2_COM_X =
        17937322431934105549617883034806379205913934344382115029331626944245539706396;
    uint256 private constant VK_S2_COM_Y =
        17879119760248184391741206496529597522202485644759307942653494489483113618871;

    uint256 private constant VK_S3_COM_X =
        2100831411431264236004652007529461575181084970226838150481708068111063577901;
    uint256 private constant VK_S3_COM_Y =
        13793409997124501333038366741107854997302419156814807843330915402527397163673;

    uint256 private constant VK_COSET_SHIFT = 5;

    uint256 private constant VK_QCP_0_X =
        8740834850571712202499125637818654457172652565328888111187735878954133488948;
    uint256 private constant VK_QCP_0_Y =
        9200735806597315880606455616861409581000797450479901075111580387244404039612;

    uint256 private constant VK_INDEX_COMMIT_API_0 = 7640375;
