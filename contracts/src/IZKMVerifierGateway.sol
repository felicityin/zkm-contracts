...
interface IZKMVerifierGatewayEvents {
...
interface IZKMVerifierGatewayErrors {
...
/// @title ZKM Verifier Gateway Interface
/// @author ZKM Labs
/// @notice This contract is the interface for the ZKM Verifier Gateway.
interface IZKMVerifierGateway is
    ...
    IZKMVerifier
{
    ...
    /// IZKMVerifierWithHash interface.
